        ...
        <div className="container nav_container">
          ...
          <div className="nav_items">
            <form action="#" className="nav_form">
              ...
              <Image src="/image/search.png" alt="Search" width={20} height={20} className="nav_search" />
            </form>
            <Image src="/image/heart.png" alt="Wishlist" width={20} height={20} className="nav_heart" />
            <a href="/cart">
              <Image src="/image/cart.png" alt="Cart" width={20} height={20} className="nav_cart" />
            </a>
          </div>
